...
import com.joyveb.cashmanage.entity.TerminalExample.Criterion;
...
public class TerminalSqlProvider {
     ...
     */
    public String countByExample(TerminalExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("t_ips_terminal");
     ...
     * @mbggenerated Wed Nov 30 11:07:10 CST 2016
     */
    public String deleteByExample(TerminalExample example) {
        BEGIN();
        DELETE_FROM("t_ips_terminal");
        applyWhere(example, false);
        return SQL();
    }
    ...
    public String insertSelective(Terminal record) {
        BEGIN();
        INSERT_INTO("t_ips_terminal");
        
        if (record.getSessionid() != null) {
            VALUES("SESSIONID", "#{sessionid,jdbcType=VARCHAR}");
        }
        
        if (record.getIsused() != null) {
            VALUES("ISUSED", "#{isused,jdbcType=CHAR}");
        }
     ...
     * @mbggenerated Wed Nov 30 11:07:10 CST 2016
     */
    public String selectByExample(TerminalExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("SESSIONID");
        } else {
            SELECT("SESSIONID");
        }
        SELECT("ISUSED");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        TerminalExample example = (TerminalExample) parameter.get("example");
        ...
        if (record.getIsused() != null) {
            SET("ISUSED = #{record.isused,jdbcType=CHAR}");
        }
     ...
     * @mbggenerated Wed Nov 30 11:07:10 CST 2016
     */
    protected void applyWhere(TerminalExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
