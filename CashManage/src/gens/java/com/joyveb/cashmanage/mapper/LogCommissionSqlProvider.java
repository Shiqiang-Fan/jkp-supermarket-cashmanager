...
import com.joyveb.cashmanage.entity.LogCommissionExample.Criterion;
...
public class LogCommissionSqlProvider {
     ...
     */
    public String countByExample(LogCommissionExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Sun Aug 20 17:47:46 CST 2017
     */
    public String deleteByExample(LogCommissionExample example) {
        BEGIN();
        DELETE_FROM("t_log_commission");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sun Aug 20 17:47:46 CST 2017
     */
    public String insertSelective(LogCommission record) {
        BEGIN();
        INSERT_INTO("t_log_commission");
     ...
     * @mbggenerated Sun Aug 20 17:47:46 CST 2017
     */
    public String selectByExample(LogCommissionExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        LogCommission record = (LogCommission) parameter.get("record");
        LogCommissionExample example = (LogCommissionExample) parameter.get("example");
        ...
        if (record!=null && record.getSecondname() != null) {
     ...
     * @mbggenerated Sun Aug 20 17:47:46 CST 2017
     */
    public String updateByPrimaryKeySelective(LogCommission record) {
        BEGIN();
        UPDATE("t_log_commission");
     ...
     * @mbggenerated Sun Aug 20 17:47:46 CST 2017
     */
    protected void applyWhere(LogCommissionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
